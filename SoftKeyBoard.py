...
from Page.Ui_SoftKeyBoard import Ui_SoftKeyBoard
...
def btn_{}_clicked(self):
    ...
    def resizeEvent(self, event):
        ...
        if h >= 360:
            ...
            self.setStyleSheet(self.set_style(22))

        elif 320 <= h < 340: # 小于 360 用15号字
            self.setStyleSheet(self.set_style(20))

        elif h < 320: # 小于 360 用15号字
            self.setStyleSheet(self.set_style(18))
